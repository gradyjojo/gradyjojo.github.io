...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateCharts(data, isInitial) {
    ...
    // Mengambil 10 urutan daerah berdasarkan setiap indikator
  ...
  function createChart(ctx, labels, data, Title, subTitle, xTitle) {
    ...
    gradient.addColorStop(0, "rgba(252, 255, 102, 1)"); // Warna awal
    gradient.addColorStop(1, "rgba(171, 208, 6, 0.1)"); // Warna akhir
    new Chart(ctx, {
      type: "bar",
      data: {
        labels: labels,
      ...
      options: {
        ...
        plugins: {
          ...
          subtitle: {
            display: true,
            text: subTitle,
            color: "#E7F9F7", // Warna subjudul chart
            font: {
              size: 12,
              style: "italic",
            },
